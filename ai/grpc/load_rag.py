...
to_korean_prompt = ChatPromptTemplate.from_messages([
    ...
    Convert the given Korean Sign Language (KSL) input into a **fluent and natural** Korean sentence. The input will include actions and postures (e.g., 고개숙이기, 상체숙이기) in addition to words. Follow these rules to ensure accurate and contextually appropriate translation:
...
def get_translate_fron_sign_language(text):
...
# get_translate_fron_sign_language("o")
